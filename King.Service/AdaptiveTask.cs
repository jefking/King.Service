namespace King.Service
{
    ...
    public abstract class AdaptiveTask : DynamicTask
    {
        ...
        public AdaptiveTask(int minimumPeriodInSeconds = BaseTimes.MinimumTiming, int maximumPeriodInSeconds = BaseTimes.MaximumTiming, Strategy strategy = Strategy.Exponential)
